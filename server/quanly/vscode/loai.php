 ...
 * @Last Modified time: 2023-04-07 12:13:04
 */

$sql = "SELECT * FROM loaimathang ";
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
                                    <a href="index.php?page=xemuser" class="btn btn-info"> Thêm loại</a>
                                    </li>
...
<h1 class="text-danger"  style="margin-top:20px;" >
<style>
		h1{
			text-align: center; 
...
<tr>
    ...
    <td>
        <a
         onclick="return confirm('Xóa loại sản phẩm ?')"
          href="index.php?page=xoaloai&IDSP=<?= $row['IDSP']?>"class="btn btn-warning">Xóa</a>
    </td>
